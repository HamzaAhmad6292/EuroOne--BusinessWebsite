  ...
  return (
    <div class="flex pt-12 px-6 md:px-20 items-center justify-center bg-hero md:h-100 overflow-hidden" style={style}>
      ...
      <div class="w-full md:w-1/2 lg:pl-32">
          ...
          <span className="" style={{colors:colors.heading}}>INDUSTRY</span>
           <span style={{ color: colors.primary }}>LY</span>
            </h2>

          
          <h3 class="mt-6 md:mt-10 text-md lg:text-xl text-center md:text-left text-gray-800 font-light tracking-wider leading-relaxed">
