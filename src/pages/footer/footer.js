	...
	<div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-400 md:space-y-12 divide-opacity-50 ">
		...
		<div className="grid justify-center pt-6 lg:justify-between">
			...
			<div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
				<a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#ff9000] dark:text-white hover:text-[#ff9000] hover:bg-white border-2 hover:border-[#ff9000]">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
						<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
						<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
					</svg>
				</a>
				<a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#ff9000] dark:text-white hover:text-[#ff9000] hover:bg-white border-2 hover:border-[#ff9000]">
				...
				<a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#ff9000] dark:text-white hover:text-[#ff9000] hover:bg-white border-2 hover:border-[#ff9000]">
